...
| ---------------------- | ------------------------------- | -------------------------------------------------------------------------------- |
| create-new             | axolotl-starter-new             | [Yoga GraphQL](https://github.com/dotansimha/graphql-yoga)                       |
| create-federation-yoga | axolotl-starter-federation-yoga | [Yoga GraphQL](https://github.com/dotansimha/graphql-yoga) with micro-federation |
...
```sh
npx @aexol/axolotl create-new my-project
```
