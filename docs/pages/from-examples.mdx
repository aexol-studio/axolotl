...
| ------------- | ----------------- | ---------------------------------------------------------- |
| create-yoga   | axolotl-starter-yoga      | [Yoga GraphQL](https://github.com/dotansimha/graphql-yoga) |
| create-federation-yoga   | axolotl-starter-federation-yoga      | [Yoga GraphQL](https://github.com/dotansimha/graphql-yoga) |
| create-deno-yoga   | axolotl-starter-deno-yoga      | [Yoga GraphQL](https://github.com/dotansimha/graphql-yoga) · [Deno](https://docs.deno.com) |
...
Will create the axolotl project using the GraphQL Yoga engine inside `my-project`
directory — **simple**!
