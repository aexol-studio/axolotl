...
Adapters transform your Axolotl resolvers into a concrete GraphQL server.
They let you write the same resolvers code and switch the underlying server
with minimal migration effort. You can also run different engines for different
parts of your graph in the future.

## Currently implemented adapters

- [GraphQL Yoga (Node.js)](/adapters/graphql-yoga)
- [GraphQL Yoga (Deno)](/adapters/deno-yoga)

> The legacy Apollo Server adapter has been removed. Historical notes remain in older commits only.
